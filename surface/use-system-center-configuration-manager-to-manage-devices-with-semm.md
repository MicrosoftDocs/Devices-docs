...
| **Surface Laptop SE**<br>**Surface Pro 7**<br>**Surface Pro 7+**<br>**Surface Go**<br>**Surface Go 2**<br>**Surface Laptop Go**<br>**Surface Laptop Go 2**<br>**Surface Laptop 3** (Intel CPU only)<br>>**Surface Laptop 4** (Intel CPU only)<br>**Surface Laptop 5** (Intel CPU only)<br> **Surface Studio 2+**| Enable or disable data            |  Enabled data, display out, and power delivery<br><br>Disabled data, display out, and power delivery                                                            |  USBPortEnabled (default)<br><br>USBPortHWDisabled                          | 370-379  |
| **Surface Pro 8**<br> **Surface Pro 9**<br>**Surface Laptop Studio**<br>**Surface Go 3**<br>                                                                                                       | N/A: No USB-A port on device      | Enabled data, display-out, and  power delivery<br><br>Disabled data but enabled display-out and power delivery<br><br>Disabled data, display-out, and power delivery | UsbPortEnabled (default)<br>UsbPortDataDisabled<br>UsbPortHwDisabled | 380-389  |

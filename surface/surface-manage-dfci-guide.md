...
| **Security features**                               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                                                                 |
| **Windows Platform Binary Table**                   | This setting lets you manage whether the Windows Platform Binary Table  (WPBT) can run on eligible devices. WPBT allows the installation of a service program or anti-theft software, potentially exposing devices to unwanted 3rd party programs that run on first boot.<br>If you enable this setting, WPBT is allowed to run.<br><br>- If you disable this setting, WPBT can't run. <br>- If you don't configure this setting, WPBT is allowed to run. | All eligible devices                                                            |

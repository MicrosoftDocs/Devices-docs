...
| Wake settings                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                                                                 |
| Wake on LAN                                         | This setting lets you manage whether eligible devices can be remotely started from Modern Standby.<br><br>- If you enable this setting, IT admins can't remotely wake eligible devices.<br>- If you disable this setting, admins can remotely wake eligible devices.<br>- If you don't configure this setting,  admins can't remotely wake eligible devices.                                                                                                                     | Supported only on Surface Laptop Go 2 and later.                                |

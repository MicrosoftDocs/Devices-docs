...
| ------ | ---------------------- | ------------------- |
| **Surface Laptop 6** ![Screenshot of Surface Laptop 6](images/surface-service-repair/surface-go-4.png) | -Display assembly (including camera)<br>-Keyboard assembly<br>-Removable solid-state drive<br>-Battery<br>-Motherboard module (main processor and main memory)<br>-Surface Connect<br>-Thermal module<br>-Audio jack<br>-Speakers<br>-Touchpad<br>-Enclosure<br>-Feet| Repair video coming soon |

...
- **64-bit (x64) apps**. With 64-bit emulation coming soon to Windows Insider program, you'll be able to run 64-bit (x64) apps on Surface Pro X. Without emulation support, you can run 64-bit (ARM64) apps, 32-bit (ARM32) apps, or 32-bit (x86) apps. You can usually find 32-bit (x86) versions of apps, but some app developers only offer 64-bit (x64) apps.

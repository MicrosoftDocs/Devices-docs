...
| SEMM port access control[<sup>7</sup>](#references)   | Yes                                                                                                                                                 | Yes                                                                                                 | No                                                             |
...
* Surface Thunderbolt 4 Dock is supported on Surface Laptop 3 with Intel processor (System SKU: Surface_Laptop_3_1867:1868). For Surface Laptop 3 with AMD processor (System SKU: Surface_Laptop_3_1873), refer to [Known issues](#known-issues) on this page.  

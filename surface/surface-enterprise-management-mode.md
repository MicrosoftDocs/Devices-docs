...
>[!TIP]
>You can now use Surface UEFI Configurator and SEMM to manage ports on Surface Dock 2. To learn more, see [Secure Surface Dock ports with SEMM](secure-surface-dock-ports-semm.md).

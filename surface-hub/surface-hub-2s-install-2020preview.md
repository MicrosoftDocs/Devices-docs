...
Windows 10 Team 2020 Update brings major improvements to device deployment and manageability along with the latest Windows 10 features. To learn more about what’s new, see the following blog post: New Surface Hub OS update released for public preview.

## Prerequisites

- Register with the [Windows Insider Program](https://insider.windows.com/).
- Download the Windows 10 Team 2020 Update Preview Build from the Windows Insider Program Dev Channel.
...
4. Under **Pick your Insider settings**, select **Dev Channel**.

...
- Confirm network access to required sites: ***.devices.microsoft.com and download.microsoft.com**. A typical way to verify access is a simple ping test: Open a command line or console and enter the following:

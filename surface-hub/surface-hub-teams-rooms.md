...
| **Default geolocation setting**                                                 | Devices > Configuration Profiles > Administrative Templates > Edge Chromium General Policies > Properties | Prevents geolocation prompt, if desired. If you don't want Zoom or Webex to track the location of your Surface Hub,  set *** BlockGeolocation (2)**. If you don't configure this setting, users will be prompted to allow Zoom or Webex to track the location of Surface Hub. |

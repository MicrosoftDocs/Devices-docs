...
- - **Dual-pen inking on Surface Hub**.   Users can whiteboard and collaborate side-by-side on Surface Hub using two Surface Hub 2 Pens. The firmware updates required to enable dual-pen inking will be released with a subsequent update.

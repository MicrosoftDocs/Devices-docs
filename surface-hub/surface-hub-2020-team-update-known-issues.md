...
| A small subset of Surface Hub 2S devices has encountered unexpected shutdowns with the thermometer icon displayed. | During regular use, some Hub 2S devices may detect an emergency thermal situation and trigger a shutdown. | A firmware update to change the thermal triggers and improve logging relating to emergency shutdowns has been released as "System Hardware Update - 5/19/2022".<br> <br>**Learn more**: [Surface Hub Update History](surface-hub-update-history.md) |
...
| A small subset of v1 Surface Hub devices is not able to automatically upgrade to the Windows 10 Team 2020 Update. | This small subset of v1 Surface Hub devices is in a state that is preventing compatibility with direct upgrade via Windows Update. | Manually reimage the device to the Windows 10 Team 2020 Update [using the Surface Hub Recovery Tool](surface-hub-recovery-tool.md). |
| Surface Hub displays "No bootable device" message after attempting to install the Windows 10 Team 2020 update. | During the Windows Update process for Windows 10 Team 2020, some Hub v1 devices will go into an unbootable state. | Manually reimage the device to the Windows 10 Team 2020 Update [using the Surface Hub Recovery Tool](surface-hub-recovery-tool.md). |

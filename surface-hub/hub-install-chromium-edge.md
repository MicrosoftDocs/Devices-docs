...
**Important:** Surface Hub requires version 85 or later of Microsoft Edge Chromium, with availability limited to the “[Dev channel](https://docs.microsoft.com/en-us/deployedge/microsoft-edge-channels),” designed to give IT admins an early look at upcoming Edge functionality and prepare for the next Beta release.  Support for the Dev channel is temporarily enabled for Windows Insiders to preview Microsoft Edge Chromium. (Normally, Surface Hub supports only versions released to the “Stable channel.”) For more information, see [Microsoft Edge channel overview.](https://docs.microsoft.com/en-us/deployedge/microsoft-edge-channels)
...
**Important:** A device reset is required to remove the new Microsoft Edge. See [Reset or recover a Surface Hub](https://docs.microsoft.com/en-us/surface-hub/device-reset-surface-hub) for more information.
...
**Note:** The Surface Hub device must be enrolled into and managed using Intune. For more information, see [Manage Surface Hub 2S with Microsoft Intune](https://docs.microsoft.com/en-us/surface-hub/surface-hub-2s-manage-intune).
...
3. Use [EnterpriseModernAppManagement Configuration Service Provider (CSP)](https://docs.microsoft.com/en-us/windows/client-management/mdm/enterprise-app-management) through your MDM provider to install Microsoft Edge.
...
**Note:** We recommend keeping the default value for these policies.
...
Use [Microsoft Edge browser policies](https://docs.microsoft.com/en-us/deployedge/microsoft-edge-policies) to configure browser settings in Microsoft Edge. These policies can be applied using one of the following options:

- [Microsoft Intune](https://docs.microsoft.com/en-us/deployedge/configure-edge-with-intune)
- [Your preferred Mobile Device Management (MDM) provider that supports ADMX Ingestion](https://docs.microsoft.com/en-us/deployedge/configure-edge-with-mdm)
...
**Note:** Microsoft Edge requires connectivity to the Internet to support its features. Ensure that the [necessary domain URLs](https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-endpoints) are added to the Allow list to ensure communications through firewalls and other security mechanisms.

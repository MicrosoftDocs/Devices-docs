...
1. Begin by installing [Windows Configuration Designer] from the Microsoft Store (https://www.microsoft.com/store/apps/9nblggh4tx22) on a separate PC running Windows 10.

...
|----------------------------------------------|---------------------------------------------------|---------------------------------------------------|
| **Plug and play third-party peripheral support**                                    | Limited to 5 specific items.                                                                             | Supports all **Teams Rooms Certified peripherals**. For more information, see the [list of certified peripherals](surface-hub-certifications.md).                                                                                                                                                 |
| **One-Touch Direct Guest Join**                                                     | Required launching Edge from Teams, leading to a web experience.                                          | Direct integration within the **Teams Rooms** application, providing seamless guest join functionality with parity to other Teams Rooms on Windows devices.                                                                                                              |
| **Front Row layout**                                                                | Not available.                                                                                           | Available with the same experience parity as other Teams Rooms on Windows devices, offering a more immersive meeting experience.                                                                                                                                        |
| **Persistent chat**                                                                 | Displayed as fleeting chat bubbles with text previews.                                                   | Includes a persistent chat pane, consistent with other Teams Rooms on Windows devices, allowing for ongoing conversations throughout meetings.                                                                                                                           |
| **Rotation and Portrait**                                                           | Not supported.                                                                                           | Now available for flexible use cases such as 1:1 video chats and easel-style whiteboarding (Surface Hub 3 and Surface Hub 3 Compute Cartridge only).                                                                                                                    |
| **Teams Admin Center and Pro Management Portal integration**                        | Experience and capabilities were inconsistent with other Teams Rooms devices.                            | Fully integrated into the **Microsoft Teams Admin Center** and **Teams Rooms Pro Management Portal**, providing a consistent management experience with other Teams Rooms devices, enabling IT admins to remotely monitor, manage, and configure devices in real time. |
| **Digital Signage**                                                                 | Not supported.                                                                                           | Now supported, allowing Teams Rooms devices to display custom content for digital signage purposes when not in active use. To learn more, see [Configure digital signage on Teams Rooms](/microsoftteams/rooms/digital-signage).                                                                                                                                             |
| **Teams Admin Center integration**           | Limited to traditional device management tools. | Full integration with the **Microsoft Teams Admin Center** and **Teams Rooms Pro Management Portal**, allowing IT admins to remotely monitor, manage, and configure devices in real time from anywhere. |
| **Access to all new Teams Rooms on Windows features**         | Limited updates and features tied to the Windows 10 Team OS, which reaches end of support on October 14,2025. | Surface Hub running Teams Rooms on Windows provides access to the latest Teams Rooms capabilities, including **AI-powered features** and **speaker recognition** for enhanced hybrid collaboration. |

...
* Resolves an issue where the [Surface Hub password rotation feature](password-management-for-surface-hub-device-accounts.md) did not work as expected with Microsoft Entra ID-based device accounts.
